...
public class RecyclerViewDecoration extends RecyclerView.ItemDecoration {
    ...
    private int leftMargin; // 每一个item与左边的间距
    private int topMargin; // 每一个item与顶部的间距
    private int rightMargin; // 每一个item与右边的间距
    private int bottomMargin; // 每一个item与底部的间距
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        // 获得当前Item在RecyclerView中的位置,从0开始
        int position = parent.getChildAdapterPosition(view);
        // 获得RecyclerView中Item的总个数
    ...
    private void verticalColumnMulti(Rect outRect, int position, int count, int spanCount) {
        ...
        // 经过对position加1对spanCount取余获得column
    ...
    private void horizontalColumnMulti(Rect outRect, int position, int count, int spanCount) {
        ...
        // 经过对position加1对spanCount取余获得row
